...
/** Bump cuando cambie el prompt o el esquema del redactor de página. 7: review-wall (muro de testimonios) y las reseñas dicen cuántas fotos traen. */
export const COPY_PROMPT_VERSION = 7;
