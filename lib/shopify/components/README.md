...
5. **Producto:** `closest.product` en bloques (Horizon); un ajuste `product` como respaldo fuera de la ficha. En secciones, `product` si existe, si no un ajuste `product`.
