...
export const STAGE_SEGMENT: Partial<Record<StageKey, string>> = { importado: "base", resenas: "reviews", angulos: "angles", textos: "copy", imagenes: "images", publicar: "publish", creativos: "creatives", anuncios: "ads", mensajes: "whatsapp" };
