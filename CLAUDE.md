...
- **Etapa Imágenes** (`/products/[id]/images`, `lib/page-images/`, `lib/pipeline/page-images.ts`, migración `20261007000000_page_images.sql`, spec `docs/spec-imagenes.md`): las imágenes de la página del producto por espacio (Portada 1:1, Galería 1:1 de 4 a 6 ordenadas, un Beneficio 3:4 por cada beneficio aprobado en Textos). Se habilita con la página aprobada; queda lista con portada y 4 de galería.
